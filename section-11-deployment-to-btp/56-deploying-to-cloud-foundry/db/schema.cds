...
entity Events : cuid, managed, softDeletable {
    ...
    pricingTiers           : Composition of many PricingTiers
                                 on pricingTiers.event = $self;
...
entity PricingTiers : cuid, temporal {
  label    : String(100);
  price    : Decimal(10, 2);
  currency : Currency;
  event    : Association to Events;
